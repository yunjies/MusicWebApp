			...
			<div class="row clearfix">
					...
					<dl>
						...
						<div class="row clearfix">
							<div class="col-md-6 column">
								<a id="modal-798561" href="#modal-container-798561" role="button" class="btn" data-toggle="modal"><button type="button" class="btn btn-default">Edit Information</button></a>
							 	
							</div>
							<div class="col-md-6 column">
								<a id="modal-798562" href="#modal-container-798562" role="button" class="btn" data-toggle="modal"><button type="button" class="btn btn-default">Change Password</button></a>
				...
				<div class="col-md-8 column">
					<table class="table table-striped">
					  <caption><h1 class="text-center"> My Playlists</h1></caption>
					  <div   style = "text-align: right;">
					  <a id="modal-798563" href="#modal-container-798563" role="button" class="btn-primary" data-toggle="modal"><button type="button" class="btn btn-default">Create New Playlist</button></a>
					</div>
				      <thead>
					 	<tr>
				    	  <th>Playlist</th>
					  	...
					  	<tbody>
						<?php
						$sql= "select pid, ptitle, pdate, pstatus from Playlist where uid = '$uid'";
						$result = $conn->query($sql);
						if ($result->num_rows > 0) {
							    // output data of each row
						  	...
						  	while($row = $result->fetch_assoc()) {
						        ...
						        <td>
						        	<div class="btn-group">
										 <button class="btn btn-default">Edit</button> <button data-toggle="dropdown" class="btn btn-default dropdown-toggle"><span class="caret"></span></button>
										<ul class="dropdown-menu">
											<li>
												<?php echo "<a href='removePlaylist.php?pid=".$row["pid"]."'>Remove</a>";
												?>
											</li>
										</ul>
									</div>	
